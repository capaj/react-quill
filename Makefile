...
build:
	...
	@cp node_modules/@capaj/quill/dist/quill.core.css dist
	@cp node_modules/@capaj/quill/dist/quill.snow.css dist
	@cp node_modules/@capaj/quill/dist/quill.bubble.css dist
	@mkdir -p $(LIB)
	@cp -Rfv $(SOURCE)/* $(LIB)
